...
function Foodmenu() {
  return (
    <div class ='box-1'>
      ...
      <button class='btnn-5'><BsPerson  style={{marginRight:'10px', marginTop:'-3px'}}/>Sign In</button>
      <button class='btnn-6'><BsMinecart style={{marginRight:'10px', marginTop:'-3px'}}/>Cart</button>
      </div>
